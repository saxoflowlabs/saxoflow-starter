...
#     """
#     Example LCEL chain:
#     PromptTemplate -> LLM -> StrOutputParser -> extract_verilog_tb_code
#     Not used today; kept as a reference if you want retries/streaming later.
#     """
#     prompt = _tbgen_prompt_template
#     return prompt | llm | StrOutputParser()
#
# class TBGenAgentLCEL(TBGenAgent):
#     """
...
#     """
#     def run(self, spec: str, rtl_code: str, top_module_name: str) -> str:
#         chain = _tbgen_prompt_template | self.llm  # | StrOutputParser()
#         raw = chain.invoke({"spec": spec, "rtl_code": rtl_code, "top_module_name": top_module_name})
#         return extract_verilog_tb_code(str(raw))
#
#     def improve(self, spec: str, prev_tb_code: str, review: str, rtl_code: str, top_module_name: str) -> str:
#         chain = _tbgen_improve_prompt_template | self.llm  # | StrOutputParser()
#         raw = chain.invoke(
#             {"spec": spec, "prev_tb_code": prev_tb_code, "review": review,
#              "rtl_code": rtl_code, "top_module_name": top_module_name}
#         )
#         return extract_verilog_tb_code(str(raw))
#
